...
import { emitirDocumentoFiscal, Produto, produtoService, CriarDocumentoFiscalPayload, isServico, formatarPreco } from "@/services/vendas";
...
const buscarProdutoPorCodigo = (codigo: string) => {
  ...
  const adicionarItemAutomaticamente = (produto: Produto, quantidade: number = 1) => {
    ...
    if (idx >= 0) {
      ...
      setItens((prev) => prev.map((it, i) => (i === idx ? calcularItem(produto, novaQtd, it.id) : it)));
