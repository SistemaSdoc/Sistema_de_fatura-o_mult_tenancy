        ...
        <MainEmpresa>
            <div className="space-y-3 pb-8 px-2 sm:px-0 max-w-6xl mx-auto" style={{ backgroundColor: colors.background }}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-lg sm:text-xl font-bold" style={{ color: colors.secondary }}>Nova Fatura Proforma</h1>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-white font-semibold text-xs uppercase tracking-wide">Dados da Proforma</span>
                    </div>
