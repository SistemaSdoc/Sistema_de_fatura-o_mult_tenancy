...
function corStatus(status: EstadoPagamento) {
    switch (status) {
        case 'pago':
        ...
        <div className="max-w-5xl mx-auto p-6 space-y-4">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-9 pr-3 py-2 rounded-lg text-sm border bg-background outline-none"
                />
            </div>
                            ...
                            <CardContent>
                                <div className="flex items-center justify-between flex-wrap gap-2">
                                    <div className="text-sm text-muted-foreground space-y-0.5">
                                        ...
                                        <p>Método: {formatMetodoPagamento(p.metodo_pagamento)}</p>
                                        <p>
                                        ...
                                        {p.status === 'rejeitado' && p.motivo_rejeicao && (
                                            <p className="text-red-500">Motivo: {p.motivo_rejeicao}</p>
                                        )}
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${corStatus(p.status)}`}>
