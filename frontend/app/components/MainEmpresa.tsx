...
export default function MainEmpresa({
  ...
  if (userLoading) {
    return (
      <div className="flex items-center justify-center w-screen h-screen rounded" style={{ backgroundColor: colors.background }}>
  ...
  return (
    <div className="flex w-screen h-screen overflow-hidden" style={{ backgroundColor: colors.background }}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 h-16 px-4 border-b transition-all duration-200" style={{ borderColor: colors.border }}>
                  ...
                  {hasLinks ? (
                    ...
                    >
                      <div className="flex items-center flex-1 gap-3 min-w-0">
                        ...
                        />
                        {sidebarOpen && (
                          <span className="text-sm font-medium truncate transition-colors duration-200" style={{ color: active ? "white" : colors.text }}>
                            {item.label}
                          </span>
                        )}
                      </div>
                      ...
                      {!sidebarOpen && (
                        <div className="absolute right-2 w-1.5 h-1.5 opacity-0 group-hover:opacity-100 transition-opacity" style={{ backgroundColor: colors.primary }} />
                      )}
                    </div>
                  ) : (
        ...
        {/* Logout Button */}
        <div className="p-2 border-t transition-colors duration-200" style={{ borderColor: colors.border }}>
          <div 
          ...
          >
            <LogOut size={19} className="text-red-500 transition-transform group-hover:scale-110" />
      ...
      <div className="flex flex-col flex-1 w-full overflow-hidden">
        {/* Header */}
        <header className="flex items-center justify-between gap-3 px-3 h-14 border-b shadow-sm md:h-16 md:px-6 transition-all duration-200" style={{ backgroundColor: colors.card, borderColor: colors.border }}>
                    ...
                    >
                      ...
                      <div className="p-3 border-b md:p-4" style={{ borderColor: colors.border }}>
                        <div className="flex items-center justify-between">
                          <h3 className="text-sm font-semibold" style={{ color: colors.text }}>Alertas de Estoque</h3>
                          <button 
                      ...
                      <div className="flex border-b" style={{ borderColor: colors.border }}>
                        <button 
                          ...
                          style={{ color: abaAtiva === "baixo" ? colors.text : colors.textSecondary }}
                        >
                        ...
                        <button 
                          ...
                          className="flex-1 py-2 px-3 text-xs font-medium transition-all hover:scale-105 relative"
                          style={{ color: abaAtiva === "zero" ? colors.text : colors.textSecondary }}
                        >
                                ...
                                <div className="flex gap-2">
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-xs mt-0.5" style={{ color: colors.textSecondary }}>
                                      {produto.estoque_atual} / {produto.estoque_minimo} unidades
                                    </p>
                                  </div>
                                </div>
                              </div>
              ...
              >
                <div className="hidden text-right md:block">
                  ...
                  <p className="text-[10px]" style={{ color: colors.textSecondary }}>
                    {userRole === "admin" ? "Admin" : userRole === "contablista" ? "Contab." : userRole === "gestor" ? "Gest." : "Op."}
                  </p>
                </div>
                <div 
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs mt-1 font-medium" style={{ color: colors.secondary }}>
                            {userRole === "admin" ? "Administrador" : userRole === "contablista" ? "Contabilista" : userRole === "gestor" ? "Gestor" : "Operador"}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              {itemComSubmenu.links.map((link) => {
                ...
                return (
                  <Link key={link.path} href={link.path} onClick={() => setSubmenuOpen(null)}>
                    ...
                    >
                      {link.icon && (
                        <link.icon size={16} style={{ color: colors.text, flexShrink: 0 }} />
                      )}
                      <span
