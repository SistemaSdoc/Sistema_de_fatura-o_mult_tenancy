...
export default function MainEmpresa({ children, companyLogo, companyName }: MainEmpresaProps) {
  ...
  const buscarNotificacoesEstoque = useCallback(
    async (force = false) => {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden" style={{ backgroundColor: colors.background }}>
      {/* ==================== SIDEBAR ==================== */}
      <aside
        className={`z-40 flex flex-col transition-all duration-300 border-r flex-shrink-0 ${
          isMobile ? "fixed left-0 top-0 h-screen" : "relative h-full"
        }`}
        style={{
        ...
        <div className="p-2 border-t transition-colors duration-200" style={{ borderColor: colors.border }}>
          <div
            ...
            <LogOut size={19} className="transition-transform group-hover:scale-110" style={{ color: `${colors.secondary}` }} />
            {sidebarOpen && (
      ...
      <div className="flex flex-col flex-1 w-full min-w-0 h-full overflow-hidden">
        {/* Header */}
        <header
          className="flex items-center justify-between gap-3 px-3 h-14 border-b shadow-sm md:h-16 md:px-6 transition-all duration-200 flex-shrink-0"
                            ...
                            {produtosEstoqueBaixo.map((produto, idx) => (
                              <div
                                ...
                                <div className="flex gap-2">
                                  <div className="p-1.5 rounded" style={{ backgroundColor: colors.warning }}>
                          ...
                          <div style={{ borderColor: colors.border }} className="divide-y">
                            {produtosSemEstoque.map((produto, idx) => (
                              <div
                                ...
                                <div className="flex gap-2">
                                  <div className="p-1.5 rounded" style={{ backgroundColor: colors.danger }}>
