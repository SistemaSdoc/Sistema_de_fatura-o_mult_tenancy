    ...
    return (
        <div className="flex w-screen h-screen overflow-hidden" style={{ backgroundColor: colors.background }}>
            ...
            >
                ...
                <div className="flex items-center justify-between gap-3 h-16 px-4 border-b transition-all duration-200 shrink-0" style={{ borderColor: colors.border }}>
                    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold shrink-0" style={{ backgroundColor: colors.primary }}>
                        {userInitial || 'A'}
                    </div>
                    ...
                    {isLoaded && menuItems.map((item) => {
                        ...
                        return (
                            <div key={item.label}>
                                {hasLinks ? (
                                    <div
                                        className="flex items-center justify-between px-3 py-2.5 rounded-lg transition-all duration-200 cursor-pointer select-none group"
                                        style={{
                                    ...
                                    >
                                        ...
                                        {!sidebarOpen && (
                                            <div className="absolute right-2 w-1.5 h-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity" style={{ backgroundColor: colors.primary }} />
                                        )}
                                    </div>
                                ) : (
                                    <Link
                ...
                <div className="p-2 border-t transition-colors duration-200 shrink-0" style={{ borderColor: colors.border }}>
                    <div
                        ...
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-all duration-200 hover:translate-x-1 active:scale-98 group"
                        title={!sidebarOpen ? "Sair" : ""}
                        style={{ backgroundColor: `${colors.danger}10` }}
                    >
                        <LogOut size={19} className="text-red-500 transition-transform group-hover:scale-110 shrink-0" />
                        {sidebarOpen && <span className="text-sm font-medium text-red-500">Sair</span>}
                    </div>
                </div>
            </aside>
                    ...
                    <div className="flex items-center gap-0.5 sm:gap-1 md:gap-2 shrink-0">
                        ...
                        <div className="relative" ref={notificacoesRef}>
                            ...
                            >
                                ...
                                {totalNotificacoes > 0 && (
                                    <span
                                        className="absolute -top-1 -right-1 text-[10px] font-bold flex items-center justify-center px-1.5 py-0.5 rounded-full text-white animate-pulse shadow-md"
                            ...
                            {notificacoesAberto && (
                                <>
                                    <div
                                        className={`fixed sm:absolute left-2 right-2 sm:left-auto sm:right-0 top-16 sm:top-auto z-50 sm:mt-2 rounded-xl overflow-hidden border shadow-xl transition-all duration-200 ${panelAnimating ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}
                                        style={{
                                            backgroundColor: colors.card,
                                            borderColor: colors.border,
                                            width: "auto",
                                    ...
                                    >
                                        <div className="p-3 border-b md:p-4" style={{ borderColor: colors.border }}>
                                            <div className="flex items-center justify-between gap-2">
                                                <h3 className="text-sm font-semibold" style={{ color: colors.text }}>Notificações</h3>
                                        ...
                                        <div className="max-h-80 overflow-y-auto">
                                            {loadingNotificacoes ? (
                                                        ...
                                                        >
                                                            <div className="flex gap-2">
                                                                <div
                                                                    ...
                                                                    style={{
                                                                        backgroundColor:
                                                                            notif.tipo === 'danger' ? colors.danger
                                                                                : notif.tipo === 'warning' ? colors.warning
                                                                                    : colors.primary,
                                                                    }}
                                                                >
                                                                ...
                                                                <div className="min-w-0 flex-1">
                                                                    ...
                                                                    {!notif.lida && (
                                                                        <span className="text-[10px]" style={{ color: colors.secondary }}>Nova</span>
                                                                    )}
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="py-8 text-center">
                                                    <p className="text-xs" style={{ color: colors.textSecondary }}>Sem notificações</p>
                                                </div>
                                            )}
                                        </div>
                        ...
                        <div className="relative" ref={userMenuRef}>
                            <button
                                ...
                                className="flex items-center gap-2 pl-1 sm:pl-2 border-l rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 px-1 py-1 sm:px-2"
                                style={{ borderColor: colors.border, backgroundColor: userMenuOpen ? colors.hover : "transparent" }}
                            ...
                            {userMenuOpen && (
                                <>
                                    <div
                                        className="fixed sm:absolute left-2 right-2 sm:left-auto sm:right-0 top-16 sm:top-auto z-50 sm:mt-2 sm:w-64 rounded-xl overflow-hidden border shadow-xl transition-all duration-200"
                                        style={{
                                            backgroundColor: colors.card,
                                            borderColor: colors.border,
                                    ...
                                    >
                                        <div className="p-3 border-b md:p-4" style={{ backgroundColor: `${colors.primary}10`, borderColor: colors.border }}>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <p className="text-sm font-semibold truncate" style={{ color: colors.text }}>{userName}</p>
                                        ...
                                        <div className="p-1">
                                            <button
                                                onClick={() => { setUserMenuOpen(false); abrirModalLogout(); }}
            ...
            {submenuOpen && itemComSubmenu && (
                <>
                    ...
                    />
                    <div
                        className={`fixed rounded-xl ${isMobile ? "bottom-0 left-0 right-0 rounded-b-none" : "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"} z-50 max-h-96 overflow-auto border transition-all duration-200 ${modalAnimating ? (isMobile ? "translate-y-full opacity-0" : "scale-95 opacity-0") : isMobile ? "translate-y-0 opacity-100" : "scale-100 opacity-100"}`}
                    ...
                    >
                        <div className="p-4 border-b sticky top-0" style={{ backgroundColor: colors.card, borderColor: colors.border }}>
                            <div className="flex items-center justify-between">
                                <h3 className="text-sm font-bold" style={{ color: colors.text }}>{itemComSubmenu.label}</h3>
                                <button
                                    onClick={() => setSubmenuOpen(null)}
                                    className="p-2 rounded-lg transition-transform hover:scale-110 active:scale-95"
            ...
            {logoutModalOpen && (
                ...
                >
                    <div
                        className={`w-full max-w-sm overflow-hidden rounded-xl shadow-xl transition-all duration-200 ${modalAnimating ? "scale-95 opacity-0" : "scale-100 opacity-100"}`}
                        style={{ backgroundColor: colors.card }}
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="p-4 border-b text-center md:p-6 md:pb-4" style={{ borderColor: colors.border }}>
                            <h2 className="text-lg font-bold md:text-xl" style={{ color: colors.text }}>Confirmar Saída</h2>
                        ...
                        <div className="p-3 border-b md:p-4" style={{ backgroundColor: theme === "dark" ? "#1a1a1a" : "#f9fafb", borderColor: colors.border }}>
                            <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                    <p className="text-xs font-medium truncate md:text-sm" style={{ color: colors.text }}>{userName}</p>
                                    <p className="text-[10px] truncate md:text-xs" style={{ color: colors.textSecondary }}>{userEmail}</p>
                                </div>
                            </div>
                        </div>
        ...
        ::-webkit-scrollbar-thumb { background: var(--scrollbar-color, #cbd5e1); border-radius: 3px; }
        ::-webkit-scrollbar-thumb:hover { background: var(--scrollbar-hover-color, #94a3b8); }
      `}</style>
        </div>
    );
}