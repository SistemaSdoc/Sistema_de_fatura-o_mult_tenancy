...
export type TipoDocumentoFiscal = "FT" | "FR" | "FP" | "RC" | "NC" | "ND" | "FA" | "FRt";
...
export interface ResumoDocumentosFiscais {
  ...
  por_tipo: Record<
    TipoDocumentoFiscal,
    { nome: string; quantidade: number; valor_total: number; mes_atual: number; retencao_total?: number }
  >;
...
function criarPayloadVenda(payload: CriarVendaPayload): Record<string, unknown> {
  ...
  if (payload.nome_banco?.trim()) out.nome_banco = payload.nome_banco.trim();
  if (payload.iban?.trim()) out.iban = payload.iban.trim();
  if (payload.numero_conta?.trim()) out.numero_conta = payload.numero_conta.trim();
...
export const vendaService = {
  async obterDadosNovaVenda(): Promise<{
    clientes: Cliente[];
    produtos: Produto[];
    estatisticas?: { total_produtos: number; total_servicos: number };
  }> {
    try {
  ...
  async listar(params?: {
    ...
    try {
      ...
      handleAxiosError(err, "[VENDA] listar");
      return null;
    }
  },
  ...
  async obter(id: string): Promise<{ message: string; venda: Venda } | null> {
    try {
      ...
      handleAxiosError(err, "[VENDA] obter");
      return null;
    }
  },
  ...
  async cancelar(id: string, motivo = "Cancelamento manual"): Promise<{ message: string; venda: Venda } | null> {
    try {
      ...
      handleAxiosError(err, "[VENDA] cancelar");
      return null;
    }
  },
  ...
  async gerarRecibo(
    id: string,
    dadosPagamento: { valor: number; metodo_pagamento: DadosPagamento["metodo"]; data_pagamento?: string; referencia?: string }
    ...
    try {
      ...
      handleAxiosError(err, "[VENDA] gerarRecibo");
      return null;
    }
  },

  async converterProformaParaFatura(
    id: string,
    dadosPagamento?: { valor: number; metodo_pagamento: DadosPagamento["metodo"]; referencia?: string }
    ...
    try {
      ...
      handleAxiosError(err, "[VENDA] converterProforma");
      return null;
    }
  },
  ...
  async estatisticas(params?: { ano?: number; mes?: number }): Promise<unknown> {
    try {
      ...
      handleAxiosError(err, "[VENDA] estatisticas");
      return null;
    }
  },
  ...
  async relatorio(params?: { tipo?: "vendas" | "proformas" | "adiantamentos"; data_inicio?: string; data_fim?: string }): Promise<unknown> {
    try {
      ...
      handleAxiosError(err, "[VENDA] relatorio");
      return null;
    }
  },
      ...
      if (!venda.totais_por_tipo) {
        ...
        venda.totais_por_tipo = {
          ...
          servicos: {
            ...
            total: servicos.reduce((s, i) => s + i.subtotal, 0),
            retencao: servicos.reduce((s, i) => s + i.valor_retencao, 0),
          },
        };
      }
...
export const documentoFiscalService = {
  async listar(params?: {
    ...
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] listar");
      return null;
    }
  },
  ...
  async emitir(payload: CriarDocumentoFiscalPayload): Promise<{ message: string; documento: DocumentoFiscal } | null> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] emitir");
      return null;
    }
  },
  ...
  async obter(id: string): Promise<{ message: string; data: { documento: DocumentoFiscal } } | null> {
    ...
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] obter");
      return null;
    }
  },
  ...
  async gerarRecibo(
    ...
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] gerarRecibo");
      return null;
    }
  },
  ...
  async criarNotaCredito(
    ...
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] criarNotaCredito");
      return null;
    }
  },
  ...
  async criarNotaDebito(
    ...
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] criarNotaDebito");
      return null;
    }
  },
  ...
  async vincularAdiantamento(
    ...
    payload: { fatura_id: string; valor: number }
    ...
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] vincularAdiantamento");
      return null;
    }
  },
  ...
  async cancelar(id: string, payload: { motivo: string }): Promise<{ message: string; documento: DocumentoFiscal } | null> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] cancelar");
      return null;
    }
  },
  ...
  async listarRecibos(documentoId: string): Promise<{ message: string; data: { recibos: DocumentoFiscal[] } } | null> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] listarRecibos");
      return null;
    }
  },

  async adiantamentosPendentes(
    clienteId?: string,
    clienteNome?: string
  ): Promise<{ message: string; data: { adiantamentos: DocumentoFiscal[] } } | null> {
    try {
      const q = new URLSearchParams();
      ...
      handleAxiosError(err, "[DOCUMENTO] adiantamentosPendentes");
      return null;
    }
  },

  async proformasPendentes(
    clienteId?: string,
    clienteNome?: string
  ): Promise<{ message: string; data: { proformas: DocumentoFiscal[] } } | null> {
    try {
      const q = new URLSearchParams();
      if (clienteId) q.append("cliente_id", clienteId);
      if (clienteNome) q.append("cliente_nome", clienteNome);
      ...
      handleAxiosError(err, "[DOCUMENTO] proformasPendentes");
      return null;
    }
  },
  ...
  async alertas(): Promise<{ message: string; data: unknown } | null> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] alertas");
      return null;
    }
  },
  ...
  async processarExpirados(): Promise<{ message: string; expirados: number } | null> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] processarExpirados");
      return null;
    }
  },
  ...
  async dashboard(): Promise<{ message: string; data: unknown } | null> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] dashboard");
      return null;
    }
  },
  ...
  async downloadPdf(id: string, nomeArquivo?: string): Promise<void> {
    try {
      ...
      handleAxiosError(err, "[DOCUMENTO] downloadPdf");
    }
  },
};
...
export const clienteService = {
  ...
  async buscar(id: string): Promise<Cliente | null> {
    try {
      ...
      handleAxiosError(err, "[CLIENTE] buscar");
      return null;
    }
  },
  ...
  async criar(dados: CriarClienteInput): Promise<Cliente | null> {
    try {
      ...
      handleAxiosError(err, "[CLIENTE] criar");
      return null;
    }
  },
  ...
  async atualizar(id: string, dados: AtualizarClienteInput): Promise<Cliente | null> {
    try {
      ...
      handleAxiosError(err, "[CLIENTE] atualizar");
      return null;
    }
  },
  ...
  async ativar(id: string): Promise<Cliente | null> {
    try {
      const { data } = await api.post(`${API}/clientes/${id}/ativar`);
      return data.cliente;
    } catch (err) {
      handleAxiosError(err, "[CLIENTE] ativar");
      return null;
    }
  },
  ...
  async inativar(id: string): Promise<Cliente | null> {
    try {
      const { data } = await api.post(`${API}/clientes/${id}/inativar`);
      return data.cliente;
    } catch (err) {
      handleAxiosError(err, "[CLIENTE] inativar");
      return null;
    }
  },
  ...
  async deletar(id: string): Promise<boolean> {
    try {
      ...
      handleAxiosError(err, "[CLIENTE] deletar");
      return false;
    }
  },
  ...
  async restaurar(id: string): Promise<Cliente | null> {
    try {
      const { data } = await api.post(`${API}/clientes/${id}/restore`);
      return data.cliente;
    } catch (err) {
      handleAxiosError(err, "[CLIENTE] restaurar");
      return null;
    }
  },
  ...
  async removerPermanentemente(id: string): Promise<boolean> {
    try {
      await api.delete(`${API}/clientes/${id}/force`);
      return true;
    } catch (err) {
      handleAxiosError(err, "[CLIENTE] removerPermanentemente");
      return false;
    }
  },
};
...
export const fornecedorService = {
  async listar(): Promise<Fornecedor[]> {
    try {
      ...
      return data.fornecedores || data || [];
    } catch (err) {
      handleAxiosError(err, "[FORNECEDOR] listar");
      return [];
    }
  },
  async buscar(id: string): Promise<Fornecedor | null> {
    try {
      ...
      handleAxiosError(err, "[FORNECEDOR] buscar");
      return null;
    }
  },
  async criar(payload: Omit<Fornecedor, "id">): Promise<Fornecedor | null> {
    try {
      const { data } = await api.post(`${API}/fornecedores`, payload);
      return data.fornecedor || data;
    } catch (err) {
      handleAxiosError(err, "[FORNECEDOR] criar");
      return null;
    }
  },
  async atualizar(id: string, payload: Partial<Omit<Fornecedor, "id">>): Promise<Fornecedor | null> {
    try {
      const { data } = await api.put(`${API}/fornecedores/${id}`, payload);
      return data.fornecedor || data;
    } catch (err) {
      handleAxiosError(err, "[FORNECEDOR] atualizar");
      return null;
    }
  },
  async deletar(id: string): Promise<boolean> {
    try {
      ...
      handleAxiosError(err, "[FORNECEDOR] deletar");
      return false;
    }
  },
};
...
export const produtoService = {
  async listar(params: ListarProdutosParams = {}): Promise<{ message: string; produtos: Produto[] | PaginatedResponse<Produto> }> {
    try {
      const q = new URLSearchParams();
      Object.entries(params).forEach(([k, v]) => {
        if (v !== undefined && v !== null && v !== false) q.append(k, String(v));
      });
      const { data } = await api.get(`${API}/produtos${q.toString() ? `?${q}` : ""}`);
      return data;
    } catch (err) {
      handleAxiosError(err, "[PRODUTO] listar");
  ...
  async listarTodos(
    ...
    try {
      ...
      handleAxiosError(err, "[PRODUTO] listarTodos");
  ...
  ): Promise<{ message: string; produtos: Produto[] | PaginatedResponse<Produto>; total_deletados: number }> {
    try {
      const q = new URLSearchParams();
      if (params.busca) q.append("busca", params.busca);
      ...
      handleAxiosError(err, "[PRODUTO] listarDeletados");
  ...
  async buscar(id: string): Promise<Produto | null> {
    try {
      ...
      handleAxiosError(err, "[PRODUTO] buscar");
      return null;
    }
  },
  ...
  async criar(dados: CriarProdutoInput): Promise<Produto | null> {
    try {
      const { data } = await api.post(`${API}/produtos`, dados);
      return data.produto;
    } catch (err) {
      handleAxiosError(err, "[PRODUTO] criar");
      return null;
    }
  },
  ...
  async atualizar(id: string, dados: AtualizarProdutoInput): Promise<Produto | null> {
    try {
      const { data } = await api.put(`${API}/produtos/${id}`, dados);
      return data.produto;
    } catch (err) {
      handleAxiosError(err, "[PRODUTO] atualizar");
      return null;
    }
  },
  ...
  async alterarStatus(id: string, status: StatusProduto): Promise<Produto | null> {
    try {
      const { data } = await api.post(`${API}/produtos/${id}/status`, { status });
      return data.produto;
    } catch (err) {
      handleAxiosError(err, "[PRODUTO] alterarStatus");
      return null;
    }
  },
  ...
  async moverParaLixeira(id: string): Promise<{ message: string; soft_deleted: boolean; id: string; deleted_at?: string } | null> {
    try {
      ...
      handleAxiosError(err, "[PRODUTO] moverParaLixeira");
      return null;
    }
  },
  ...
  async restaurar(id: string): Promise<Produto | null> {
    try {
      const { data } = await api.post(`${API}/produtos/${id}/restore`);
      return data.produto;
    } catch (err) {
      handleAxiosError(err, "[PRODUTO] restaurar");
      return null;
    }
  },
  ...
  async deletarPermanentemente(id: string): Promise<{ message: string; id: string } | null> {
    try {
      const { data } = await api.delete(`${API}/produtos/${id}/force`);
      return data;
    } catch (err) {
      handleAxiosError(err, "[PRODUTO] deletarPermanentemente");
      return null;
    }
  },
  ...
  async listarCategorias(params?: { tipo?: "produto" | "servico" }): Promise<Categoria[]> {
    try {
      ...
      handleAxiosError(err, "[PRODUTO] listarCategorias");
      return [];
    }
  },

  async listarServicos(params: Omit<ListarProdutosParams, "tipo"> = {}) {
    return this.listar({ ...params, tipo: "servico" });
  },
  async listarApenasProdutos(params: Omit<ListarProdutosParams, "tipo"> = {}) {
    return this.listar({ ...params, tipo: "produto" });
  },
...
export const categoriaService = {
  async listar(params?: { tipo?: "produto" | "servico" }): Promise<Categoria[]> {
    try {
      ...
      handleAxiosError(err, "[CATEGORIA] listar");
      return [];
    }
  },
  async criar(payload: CategoriaPayload): Promise<Categoria | null> {
    try {
      ...
      handleAxiosError(err, "[CATEGORIA] criar");
      return null;
    }
  },
  async atualizar(id: string, payload: Partial<CategoriaPayload>): Promise<Categoria | null> {
    try {
      const { data } = await api.put(`${API}/categorias/${id}`, payload);
      return data.categoria || data;
    } catch (err) {
      handleAxiosError(err, "[CATEGORIA] atualizar");
      return null;
    }
  },
  async deletar(id: string): Promise<boolean> {
    try {
      ...
      handleAxiosError(err, "[CATEGORIA] deletar");
      return false;
    }
  },
  async buscar(id: string): Promise<Categoria | null> {
    try {
      ...
      handleAxiosError(err, "[CATEGORIA] buscar");
      return null;
    }
  },
};
...
export const stockService = {
  async listar(
    ...
    try {
      ...
      handleAxiosError(err, "[STOCK] listar");
      return [];
    }
  },
  ...
  async resumo(): Promise<{
    ...
    try {
      const { data } = await api.get(`${API}/movimentos-stock/resumo`);
      return data;
    } catch (err) {
  ...
  async historicoProduto(
    ...
    try {
      const { data } = await api.get(`${API}/movimentos-stock/produto/${produtoId}?page=${page}`);
      return data;
    } catch (err) {
  ...
  async criar(payload: CriarMovimentoPayload): Promise<MovimentoStock | null> {
    try {
      ...
      handleAxiosError(err, "[STOCK] criar");
      return null;
    }
  },
  ...
  async ajuste(produto_id: string, quantidade: number, motivo: string, custo_medio?: number) {
    try {
      const { data } = await api.post(`${API}/movimentos-stock/ajuste`, { produto_id, quantidade, motivo, custo_medio });
      return data;
    } catch (err) {
      handleAxiosError(err, "[STOCK] ajuste");
      return null;
    }
  },
  ...
  async transferencia(produto_origem_id: string, produto_destino_id: string, quantidade: number, motivo: string) {
    try {
      const { data } = await api.post(`${API}/movimentos-stock/transferencia`, {
        produto_origem_id,
        produto_destino_id,
        quantidade,
        motivo,
      ...
      handleAxiosError(err, "[STOCK] transferencia");
      return null;
    }
  },
  ...
  async obter(id: string): Promise<MovimentoStock | null> {
    try {
      const { data } = await api.get(`${API}/movimentos-stock/${id}`);
      return data.movimento;
    } catch (err) {
      handleAxiosError(err, "[STOCK] obter");
      return null;
    }
  },
  ...
  async estatisticas(params: { data_inicio?: string; data_fim?: string; produto_id?: string } = {}) {
    try {
      ...
      handleAxiosError(err, "[STOCK] estatisticas");
      return null;
    }
  },
  ...
  async verificarDisponibilidade(
    produto_id: string,
    quantidade: number
  ): Promise<{ disponivel: boolean; estoque_atual: number; mensagem?: string }> {
    ...
    return {
      ...
      mensagem: disponivel ? undefined : `Stock insuficiente. Disponível: ${produto.estoque_atual}`,
    };
  },
};
...
export const dashboardService = {
  async fetch(): Promise<DashboardResponse | null> {
    ...
    if (dashboardCache && dashboardCache.tenant === tenantKey && agora - dashboardCache.at < DASHBOARD_CACHE_TTL) {
  ...
  async estatisticasPagamentos(): Promise<EstatisticasPagamentos | null> {
    try {
      ...
      return data.data?.estatisticas ?? null;
    } catch (err) {
  ...
  async evolucaoMensal(ano?: number): Promise<EvolucaoMensal | null> {
    try {
      ...
      return data.data?.evolucao ?? null;
    } catch (err) {
...
export const relatorioService = {
  async documentosFiscais(params?: {
    ...
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] documentosFiscais");
      return null;
    }
  },
  async pagamentosPendentes() {
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] pagamentosPendentes");
      return null;
    }
  },
  async vendas(params?: {
    ...
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] vendas");
      return null;
    }
  },
  async compras(params?: { data_inicio?: string; data_fim?: string }) {
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] compras");
      return null;
    }
  },
  async stock() {
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] stock");
      return null;
    }
  },
  async proformas(params?: { data_inicio?: string; data_fim?: string; cliente_id?: string; pendentes?: boolean }) {
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] proformas");
      return null;
    }
  },
  async servicos(params?: { data_inicio?: string; data_fim?: string; apenas_ativos?: boolean }) {
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] servicos");
      return null;
    }
  },
  async retencoes(params?: { data_inicio?: string; data_fim?: string; cliente_id?: string }) {
    try {
      ...
      handleAxiosError(err, "[RELATÓRIO] retencoes");
      return null;
    }
  },
};
...
export function getTipoDocumentoColor(tipo: TipoDocumentoFiscal): string {
  return (
    (
      ...
      } as Record<TipoDocumentoFiscal, string>
...
export async function obterDadosNovaVenda() {
...
export async function obterResumoDocumentosFiscais() {
...
export async function obterAlertasPendentes() {
  return dashboardService.alertasPendentes();
}
export async function obterEvolucaoMensal(ano?: number) {
