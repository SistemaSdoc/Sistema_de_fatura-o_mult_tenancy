...
return new class extends Migration
{
    ...
    {
        // ── Vendas ────────────────────────────────────────────────────────
        Schema::connection('shared')->create('vendas', function (Blueprint $table) {
        ...
        // ── Itens da venda ────────────────────────────────────────────────
        Schema::connection('shared')->create('itens_venda', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('tenant_id');
    ...
    {
        Schema::connection('shared')->dropIfExists('itens_venda');
        Schema::connection('shared')->dropIfExists('vendas');
    }
};