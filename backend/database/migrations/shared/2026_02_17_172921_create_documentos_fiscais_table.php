...
return new class extends Migration
{
    ...
    {
        // ── Documentos Fiscais ────────────────────────────────────────────
        Schema::connection('shared')->create('documentos_fiscais', function (Blueprint $table) {
        ...
        Schema::connection('shared')->create('itens_documento_fiscal', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('tenant_id');
        ...
        Schema::connection('shared')->create('adiantamento_fatura', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('tenant_id');
    ...
    {
        Schema::connection('shared')->dropIfExists('adiantamento_fatura');
        Schema::connection('shared')->dropIfExists('itens_documento_fiscal');
        Schema::connection('shared')->dropIfExists('documentos_fiscais');
    }
};