  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body {
      ...
      background: white; color: #000; width: 80mm;
    }
    ...
    .talao { width: 80mm; padding: 4mm 4mm 6mm; background: white; }
    ...
    .header { text-align: center; padding-bottom: 8px; margin-bottom: 8px; border-bottom: 1px dashed #666; }
    .header .logo { width: 55px; height: 55px; object-fit: contain; display: block; margin: 0 auto 6px; }
    .header .empresa-nome { font-size: 15px; font-weight: bold; text-transform: uppercase; margin-bottom: 3px; }

    .doc-info { padding-bottom: 6px; margin-bottom: 6px; border-bottom: 1px dashed #666; }
    .doc-info .tipo-numero { display: flex; justify-content: space-between; font-size: 13px; font-weight: bold; }

    .origem-box { background: #f0f0f0; padding: 4px 6px; margin-bottom: 6px; font-size: 10px; }
    .cliente-block { padding-bottom: 6px; margin-bottom: 6px; border-bottom: 1px dashed #666; }

    .itens-block { padding-bottom: 6px; margin-bottom: 6px; border-bottom: 2px dashed #666; }
    .itens-header { display: flex; justify-content: space-between; font-size: 10px; font-weight: bold; border-bottom: 1px solid #ccc; padding-bottom: 3px; margin-bottom: 4px; }
    .item { margin-bottom: 5px; }
    .item-desc { font-size: 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .item-valores { display: flex; justify-content: space-between; font-size: 10px; }
    ...
    .totais-block { padding-bottom: 6px; margin-bottom: 6px; border-bottom: 1px dashed #666; }
    .total-row { display: flex; justify-content: space-between; font-size: 10px; margin-bottom: 2px; }
    .total-grand { display: flex; justify-content: space-between; font-size: 14px; font-weight: bold; border-top: 2px solid #000; margin-top: 4px; padding-top: 4px; }
    .ret-valor { color: #dc2626; }

    /* QR Code — 36mm centrado */
    .qr-block { text-align: center; padding: 6px 0 4px; margin-bottom: 6px; border-bottom: 1px dashed #666; }
    .qr-label { font-size: 9px; color: #555; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.05em; }
    #qr-canvas { display: inline-block; line-height: 0; }
    #qr-canvas canvas,
    #qr-canvas img { width: 36mm !important; height: 36mm !important; image-rendering: pixelated; }
    .qr-texto { font-size: 7.5px; color: #666; word-break: break-all; margin-top: 3px; line-height: 1.3; padding: 0 2mm; }

    .hash-block { text-align: center; margin-bottom: 8px; padding: 4px 0; }

    .bank-block { font-size: 10px; text-align: center; border-top: 1px dashed #666; padding-top: 8px; }
...
(function () {
  ...
  if (texto && typeof QRCode !== 'undefined') {
    new QRCode(el, {
      text: texto, width: 136, height: 136,
