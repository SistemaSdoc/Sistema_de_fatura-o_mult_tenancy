...
class DashboardController extends Controller
{
    ...
    {
        // NÃO precisa de DB::connection('tenant'), tenancy() já define a conexão
        // Todas as queries abaixo vão usar o banco correto do tenant

        // Total de faturas emitidas
        $user = auth()->guard('sanctum')->user(); // ou guard tenant
        ...
        // Últimas 5 faturas com dados do cliente em JOIN (evita N+1)
